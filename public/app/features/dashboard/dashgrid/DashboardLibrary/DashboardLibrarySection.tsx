...
import { useStyles2, Stack, Grid, Pagination, EmptyState, Button, Alert } from '@grafana/ui';
    ...
    <Stack direction="column" gap={2} justifyContent="space-between" height="100%">
      {showError ? (
        <Stack direction="column" alignItems="center" gap={2}>
          <Alert
            title={t('dashboard-library.provisioned-error-title', 'Error loading provisioned dashboards')}
            severity="error"
          >
            <Trans i18nKey="dashboard-library.provisioned-error">
              Failed to load provisioned dashboards. Please try again.
            </Trans>
          </Alert>
